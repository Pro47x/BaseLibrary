...
import com.minicart.android.baselibrary.ui.recyclerview.utils.CustomRecyclerViewUtils;
...
public class RecyclerViewExpandableItemManager implements ExpandableItemConstants {
    ...
    public long getPackedPositionGroup(int flatPosition) {
        if (mWrapperAdapter == null) {
            return ExpandableAdapterHelper.NO_EXPANDABLE_POSITION;
        }
        return mWrapperAdapter.getPackedPositionGroup(flatPosition);
    }

    public long getPackedPositionChild(int flatPosition) {
        if (mWrapperAdapter == null) {
            return ExpandableAdapterHelper.NO_EXPANDABLE_POSITION;
        }
        return mWrapperAdapter.getPackedPositionChild(flatPosition);
    }
    ...
    public boolean isGroup(int position) {
        return mWrapperAdapter.isGroup(position);
    }
