...
import com.minicart.android.baselibrary.dagger2.delegate.*
    ...
    internal class FragmentLifecycle : FragmentManager.FragmentLifecycleCallbacks() {
        ...
        private fun fetchFragmentDelegate(fragment: Fragment): FragmentDelegate? {
            if (fragment is IFragment) {
                ...
                return fragment.arguments.getParcelable<Parcelable>(FragmentDelegate.FRAGMENT_DELEGATE) as FragmentDelegate
            }
            return null
        }
    }
